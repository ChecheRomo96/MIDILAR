    ...
    namespace MIDILAR::SystemFoundation {
         ...
         */
            ...
            public:
                ...
                using ClockCallback = CallbackHandler<uint32_t, void>;
                using SetupCallback = CallbackHandler<void, Clock::TimePoint>;
            ...
            protected:
                ...
                CallbackHandler<uint32_t, void>  _clockPoll; /**< Pointer to the hardware callback function. */
                CallbackHandler<void, TimePoint>  _clockSetup; /**< Pointer to the hardware callback function. */
