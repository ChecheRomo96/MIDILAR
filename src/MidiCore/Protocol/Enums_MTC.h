#ifndef MIDILAR_MIDI_CORE_PROTOCOL_ENUMS_MTC_H
#define MIDILAR_MIDI_CORE_PROTOCOL_ENUMS_MTC_H
    ...
    /**
     * @namespace MIDILAR::MidiCore::Protocol::MTC
    ...
    /** 
     * @brief Alias for `MIDILAR::MidiCore::Protocol::MTC`.
     * 
     * All functionality is defined in the `MIDILAR::MidiCore::Protocol::MTC` namespace.
     */
    namespace MidiProtocol_MTC = MIDILAR::MidiCore::Protocol::MTC;
    

#endif // MIDILAR_MIDI_CORE_PROTOCOL_ENUMS_MTC_H