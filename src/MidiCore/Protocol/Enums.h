#ifndef MIDILAR_MIDI_CORE_PROTOCOL_ENUMS_H
#define MIDILAR_MIDI_CORE_PROTOCOL_ENUMS_H

    #include <MIDILAR_BuildSettings.h>
    #include <stdint.h>
    #include "Defines.h"

    namespace MIDILAR::MidiCore::Protocol {
    ...
    namespace MidiProtocol = MIDILAR::MidiCore::Protocol;
    namespace MidiProtocol_SystemCommon = MIDILAR::MidiCore::Protocol::SystemCommon;
    namespace MidiProtocol_RealTime = MIDILAR::MidiCore::Protocol::SystemCommon::RealTime;
    namespace MidiProtocol_SysEx = MIDILAR::MidiCore::Protocol::SystemCommon::SystemExclusive;


    #include "Enums_MTC.h"

#endif//MIDILAR_MIDI_CORE_PROTOCOL_ENUMS_H