#ifndef MIDILAR_DSPCORE_GENERATORS_ENVELOPES_EXPSEGMENT_H
#define MIDILAR_DSPCORE_GENERATORS_ENVELOPES_EXPSEGMENT_H
...
#endif // MIDILAR_DSPCORE_GENERATORS_ENVELOPES_EXPSEGMENT_H