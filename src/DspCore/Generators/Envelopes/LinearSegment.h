#ifndef MIDILAR_DSPCORE_GENERATORS_ENVELOPES_LINEARSEGMENT_H
#define MIDILAR_DSPCORE_GENERATORS_ENVELOPES_LINEARSEGMENT_H
...
#endif // MIDILAR_DSPCORE_GENERATORS_ENVELOPES_LINEARSEGMENT_H