#ifndef MIDILAR_DSPCORE_GENERATORS_ENVELOPES_LUTSEGMENT_H
#define MIDILAR_DSPCORE_GENERATORS_ENVELOPES_LUTSEGMENT_H

#include <MIDILAR_BuildSettings.h>
#include <stddef.h>

#include <DspCore/LUT/LUT1D/LUT1D.h>
#include <DspCore/Interpolators/Linear/Linear.h>
...
namespace MIDILAR::DspCore::Generators::Envelopes {
    ...
    void LUTSegment(
        ...
        size_t TotalSamples,
        const MIDILAR::DspCore::LUT::LUT1D<LUT_TYPE>& Table,
        ...
        for (size_t i = 0; i < LocalLength; i++) {
            ...
            float Shaped = static_cast<float>(
                MIDILAR::DspCore::Interpolation::Linear(Y0, Y1, Alpha)
            );
...
#endif // MIDILAR_DSPCORE_GENERATORS_ENVELOPES_LUTSEGMENT_H