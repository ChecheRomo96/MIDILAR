...
# Generators
    ...
    option(MIDILAR_DSP_GENERATORS "Enables the compilation of MIDILAR::DspCore::Generators" ON)
    include(${CMAKE_CURRENT_LIST_DIR}/Generators/CMakeOptions.cmake)
#
##################################################################################################################################
# Interpolators

    option(MIDILAR_DSP_INTERPOLATORS "Enables the compilation of MIDILAR::DspCore::Interpolators" ON)
    include(${CMAKE_CURRENT_LIST_DIR}/Interpolators/CMakeOptions.cmake)
#
##################################################################################################################################
# LUT

    option(MIDILAR_DSP_LUT "Enables the compilation of MIDILAR::DspCore::LUT" ON)
    include(${CMAKE_CURRENT_LIST_DIR}/LUT/CMakeOptions.cmake)
#
##################################################################################################################################
# Streaming

    option(MIDILAR_DSP_STREAMING "Enables the compilation of MIDILAR::DspCore::Streaming" ON)
    #include(${CMAKE_CURRENT_LIST_DIR}/Streaming/CMakeOptions.cmake)
#
##################################################################################################################################
# Transforms

    option(MIDILAR_DSP_TRANSFORMS "Enables the compilation of MIDILAR::DspCore::Transforms" ON)
