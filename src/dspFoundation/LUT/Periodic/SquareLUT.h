...
#define MIDILAR_SQUARE_LUT_H
    ...
    namespace MIDILAR::dspFoundation::LUT::Periodic {
        ...
        class SquareLUT : public LUT::LUT1D<INPUT_TYPE, OUTPUT_TYPE> {
        private:
        ...
        protected:
            ...
            void Eval() override {
                ...
                SquareGenerator(this->_buffer, bufferSize, _amplitude, _offset, _phase_offset);
            }

        public:
            /**
             * @brief Constructor for SquareLUT.
             */
            SquareLUT()
