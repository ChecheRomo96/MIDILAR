#ifndef MIDILAR_DSPFOUNDATION_GENERATORS_ENVELOPES_LOGSEGMENT_H
#define MIDILAR_DSPFOUNDATION_GENERATORS_ENVELOPES_LOGSEGMENT_H
...
#endif // MIDILAR_DSPFOUNDATION_GENERATORS_ENVELOPES_LOGSEGMENT_H