#ifndef MIDILAR_GENERATORS_WINDOWING_NUTTALL_H
#define MIDILAR_GENERATORS_WINDOWING_NUTTALL_H
...
namespace MIDILAR::dspFoundation::Generators::Windowing {
    ...
    template<typename T>
    void Nuttall(T* Buffer, size_t BufferSize) {
...
#endif // MIDILAR_GENERATORS_WINDOWING_NUTTALL_H
