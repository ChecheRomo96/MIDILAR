#ifndef MIDILAR_GENERATORS_WINDOWING_BARTLETT_H
#define MIDILAR_GENERATORS_WINDOWING_BARTLETT_H
...
namespace MIDILAR::dspFoundation::Generators::Windowing {
    ...
    template<typename T>
    void Bartlett(T* Buffer, size_t BufferSize) {
...
#endif // MIDILAR_GENERATORS_WINDOWING_BARTLETT_H
